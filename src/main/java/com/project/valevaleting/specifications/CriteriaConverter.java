...
import com.project.valevaleting.utils.DateTimeUtils;
import com.project.valevaleting.utils.EnumUtils;
import com.project.valevaleting.utils.IAppendableReferenceUtils;
...
import static com.project.valevaleting.specifications.Constants.*;
import static com.project.valevaleting.specifications.IQueryToCriteria.*;

import static com.project.valevaleting.specifications.ObjectParser.*;
...
public class CriteriaConverter {
    ...
    public static List<Criteria> queryToCriteria(String query, String... ignoreParameters) {
        ...
        if (!StringUtils.hasText(query) || !query.contains("=") || !query.contains("~")) {
            return criteriaList;
        }
     ...
     */
    public static Predicate asPredicate(Criteria criteria, Root<?> root, CriteriaBuilder criteriaBuilder) {
